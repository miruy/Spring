	...
	<form:form method="post" commandName="bookCmd" enctype="multipart/form-data">
		<table border="1">
			...
			<tr>
				...
				<td><input required type="text" name="author"></td>
			</tr>
			<tr>
				<th style="text-align: left;"><span style="color: red;">*</span>출판사</th>
				<td><input required type="text" name="pubcompany"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="2"><textarea required name="contents" rows="13" cols="40"></textarea></td>
			</tr>
		</table>
